                    ...
                    <div class="space-y-6">
                        ...
                        <a href="https://maps.app.goo.gl/jaYY7THz7W9npx3F8" target="_blank" rel="noopener" class="flex items-start gap-4 group">
                            ...
                            <div>
                                ...
                                <p class="text-gray-500 group-hover:text-brand transition-colors">14321 Winter Breeze Drive, Suite #55<br />
            ...
            <div class="grid md:grid-cols-4 gap-10 mb-12">
                ...
                <div class="md:col-span-1">
                    ...
                    <p class="text-gray-300 text-sm mt-4 leading-relaxed">
                        Full-stack digital agency building scalable, custom cloud solutions from our offices in Central Virginia.
                    </p>
                </div>
                ...
                <div>
                    ...
                    <ul class="space-y-3">
                        <li>
                            <a href="mailto:hello@divstrong.com" class="inline-flex items-center gap-2 text-sm text-gray-300 hover:text-white transition-colors">
                                <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/></svg>
                                hello@divstrong.com
                            </a>
                        </li>
                        <li>
                            <a href="tel:+18043159609" class="inline-flex items-center gap-2 text-sm text-gray-300 hover:text-white transition-colors">
                                <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"/></svg>
                                +1 (804) 315-9609
                            </a>
                        </li>
                        <li class="pt-5">
                            <a href="https://www.linkedin.com/company/divstrong" target="_blank" rel="noopener" class="inline-flex items-center gap-2 text-sm text-gray-300 hover:text-white transition-colors">
